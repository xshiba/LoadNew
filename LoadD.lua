...
old = hookmetamethod(game, "__namecall", function(...)
    local method, args = (...), ({select(2,...)});
    if tostring(getnamecallmethod()) == "FireServer" and tostring(method) == "RemoteEvent" and tostring(args[2]) ~= "true" and tostring(args[2]) ~= "false" then 
    ...
    elseif tostring(getnamecallmethod()) == "InvokeServer" and tostring(method) == "" and tostring(args[2]) ~= "true" and tostring(args[2]) ~= "false" then 
        if _G.SaveSettings.AimbotSkill then
            if _G.TargetPlayerAim ~= nil then
